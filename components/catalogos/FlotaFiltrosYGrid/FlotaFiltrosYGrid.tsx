...
// Única pieza de /flota que depende de useSearchParams — vive en su propio
// Suspense boundary (ver app/[locale]/flota/page.tsx) para que el Hero y el
// CTA de esa página se sirvan como HTML estático desde el primer byte.
